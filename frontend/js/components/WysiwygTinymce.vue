    ...
    methods: {
      init () {
        const editorOptions = {
          ...
          convert_urls: false,
          entity_encoding: 'raw',
          valid_children: '+a[p|a|div|span|b|strong|i|u|sup|sub|img|#text|tr|td|label|h1|h2|h3|h4|h5|h6],+span[p|a|div|span|b|strong|i|u|sup|sub|img|#text|tr|td|label|h1|h2|h3|h4|h5|h6],+div[p|a|div|span|b|strong|i|u|sup|sub|img|#text|tr|td|label|h1|h2|h3|h4|h5|h6]',
